...
fn check_repr() {
    let known_variants = [
        ...
        (IoTypeMetadataKind::VariableBytes512, 73),
        (IoTypeMetadataKind::VariableBytes1024, 74),
        (IoTypeMetadataKind::VariableBytes2028, 75),
        (IoTypeMetadataKind::VariableBytes4096, 76),
        (IoTypeMetadataKind::VariableBytes8192, 77),
        (IoTypeMetadataKind::VariableBytes16384, 78),
        (IoTypeMetadataKind::VariableBytes32768, 79),
        (IoTypeMetadataKind::VariableBytes65536, 80),
        (IoTypeMetadataKind::VariableBytes131072, 81),
        (IoTypeMetadataKind::VariableBytes262144, 82),
        (IoTypeMetadataKind::VariableBytes524288, 83),
        (IoTypeMetadataKind::VariableBytes1048576, 84),
