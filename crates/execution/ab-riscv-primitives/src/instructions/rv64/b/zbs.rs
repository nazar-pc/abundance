    ...
    fn try_decode(instruction: u32) -> Option<Self> {
        ...
        match opcode {
            ...
            0b001_0011 => {
                ...
                let rs1 = Reg::from_bits(rs1_bits)?;
                match (funct3, funct6) {
                    (0b001, 0b00_1010) => Some(Self::Bseti { rd, rs1, shamt }),
                    (0b001, 0b01_0010) => Some(Self::Bclri { rd, rs1, shamt }),
                    (0b001, 0b01_1010) => Some(Self::Binvi { rd, rs1, shamt }),
                    (0b101, 0b01_0010) => Some(Self::Bexti { rd, rs1, shamt }),
                    _ => None,
                }
            }
            _ => None,
