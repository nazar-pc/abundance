    ...
    fn try_decode(instruction: u32) -> Option<Self> {
        ...
        match quadrant {
            ...
            0b00 => match funct3 {
                ...
                0b011 => {
                    let uimm5_3 = ((inst >> 10) & 0b111) as u8;
                    let uimm7_6 = ((inst >> 5) & 0b11) as u8;
                    let uimm = (uimm7_6 << 6) | (uimm5_3 << 3);
                    let rs1_bits = prime_reg_bits(((inst >> 7) & 0b111) as u8);
                    let rd_bits = prime_reg_bits(((inst >> 2) & 0b111) as u8);
                    let rs1 = Reg::from_bits(rs1_bits)?;
                    let rd = Reg::from_bits(rd_bits)?;
            ...
            0b10 => match funct3 {
                ...
                0b011 => {
                    ...
                    let rd = Reg::from_bits(rd_bits)?;
                    let uimm5 = (inst >> 12) & 1;
                    let uimm43 = (inst >> 5) & 0b11;
                    let uimm86 = (inst >> 2) & 0b111;
                    let uimm = (uimm86 << 6) | (uimm5 << 5) | (uimm43 << 3);
                ...
                0b111 => {
                    let rs2_bits = ((inst >> 2) & 0x1f) as u8;
                    let rs2 = Reg::from_bits(rs2_bits)?;
                    let uimm53 = (inst >> 10) & 0b111;
                    let uimm86 = (inst >> 7) & 0b111;
                    let uimm = (uimm86 << 6) | (uimm53 << 3);
