...
/// `[funct6(6)|vm(1)|vs2(5)|vs1_or_rs1_or_imm(5)|funct3(3)|vd(5)|0b101_0111]`
///
...
fn make_v_arith(funct6: u8, vm: bool, vs2: u8, vs1: u8, funct3: u8, vd: u8) -> u32 {
    let vm_bit = u8::from(vm);
    let funct7 = (funct6 << 1u8) | vm_bit;
...
fn test_vsaddu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VsadduVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vsaddu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VsadduVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vsaddu_vi() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VsadduVi {
            vd: VReg::V1,
            vs2: VReg::V2,
            imm: 5,
            vm: true,
...
fn test_vsadd_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VsaddVv {
            vd: VReg::V10,
            vs2: VReg::V8,
            vs1: VReg::V9,
            vm: true,
...
fn test_vsadd_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VsaddVx {
            vd: VReg::V12,
            vs2: VReg::V8,
            rs1: Reg::A0,
            vm: true,
...
fn test_vsadd_vi() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VsaddVi {
            vd: VReg::V12,
            vs2: VReg::V8,
            imm: 15,
            vm: true,
...
fn test_vssubu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssubuVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vssubu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssubuVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vssub_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssubVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vssub_vx_masked() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssubVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: false,
...
fn test_vaaddu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VaadduVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vaaddu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VaadduVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn test_vaadd_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VaaddVv {
            vd: VReg::V6,
            vs2: VReg::V4,
            vs1: VReg::V5,
            vm: true,
...
fn test_vaadd_vx_masked() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VaaddVx {
            vd: VReg::V6,
            vs2: VReg::V4,
            rs1: Reg::A1,
            vm: false,
...
fn test_vasubu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VasubuVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vasubu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VasubuVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vasub_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VasubVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vasub_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VasubVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vsmul_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VsmulVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vsmul_vx_masked() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VsmulVx {
            vd: VReg::V12,
            vs2: VReg::V8,
            rs1: Reg::A0,
            vm: false,
...
fn test_vssrl_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssrlVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vssrl_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssrlVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vssrl_vi() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssrlVi {
            vd: VReg::V1,
            vs2: VReg::V2,
            imm: 7,
            vm: true,
...
fn test_vssra_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssraVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vssra_vx_masked() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssraVx {
            vd: VReg::V12,
            vs2: VReg::V8,
            rs1: Reg::A0,
            vm: false,
...
fn test_vssra_vi() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VssraVi {
            vd: VReg::V8,
            vs2: VReg::V4,
            imm: 31,
            vm: true,
...
fn test_vnclipu_wv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VnclipuWv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vnclipu_wx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VnclipuWx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vnclipu_wi() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VnclipuWi {
            vd: VReg::V1,
            vs2: VReg::V2,
            imm: 3,
            vm: true,
...
fn test_vnclip_wv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VnclipWv {
            vd: VReg::V6,
            vs2: VReg::V4,
            vs1: VReg::V5,
            vm: true,
...
fn test_vnclip_wx_masked() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VnclipWx {
            vd: VReg::V6,
            vs2: VReg::V4,
            rs1: Reg::A1,
            vm: false,
...
fn test_vnclip_wi() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xFixedPointInstruction::VnclipWi {
            vd: VReg::V6,
            vs2: VReg::V4,
            imm: 0,
            vm: true,
