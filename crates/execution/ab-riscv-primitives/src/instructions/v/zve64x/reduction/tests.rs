...
fn test_vredsum() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vredsum {
            vd: VReg::V3,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
fn test_vredand() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vredand {
            vd: VReg::V6,
            vs2: VReg::V4,
            vs1: VReg::V5,
            vm: true,
...
fn test_vredor() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vredor {
            vd: VReg::V10,
            vs2: VReg::V8,
            vs1: VReg::V9,
            vm: true,
...
fn test_vredxor() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vredxor {
            vd: VReg::V14,
            vs2: VReg::V12,
            vs1: VReg::V13,
            vm: true,
...
fn test_vredminu() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vredminu {
            vd: VReg::V18,
            vs2: VReg::V16,
            vs1: VReg::V17,
            vm: true,
...
fn test_vredmin() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vredmin {
            vd: VReg::V22,
            vs2: VReg::V20,
            vs1: VReg::V21,
            vm: true,
...
fn test_vredmaxu() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vredmaxu {
            vd: VReg::V26,
            vs2: VReg::V24,
            vs1: VReg::V25,
            vm: true,
...
fn test_vredmax() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vredmax {
            vd: VReg::V30,
            vs2: VReg::V28,
            vs1: VReg::V29,
            vm: true,
...
fn test_vwredsumu() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vwredsumu {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
fn test_vwredsum() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xReductionInstruction::Vwredsum {
            vd: VReg::V12,
            vs2: VReg::V8,
            vs1: VReg::V4,
            vm: true,
