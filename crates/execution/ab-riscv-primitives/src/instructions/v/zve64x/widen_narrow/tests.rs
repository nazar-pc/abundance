...
fn test_vwaddu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwadduVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vwaddu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwadduVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn test_vwadd_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwaddVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vwadd_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwaddVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vwsubu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwsubuVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vwsubu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwsubuVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn test_vwsub_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwsubVv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vwsub_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwsubVx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vwaddu_wv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwadduWv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vwaddu_wx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwadduWx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn test_vwadd_wv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwaddWv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vwadd_wx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwaddWx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vwsubu_wv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwsubuWv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vwsubu_wx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwsubuWx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn test_vwsub_wv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwsubWv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vwsub_wx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VwsubWx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::T0,
            vm: true,
...
fn test_vnsrl_wv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VnsrlWv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vnsrl_wx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VnsrlWx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn test_vnsrl_wi() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VnsrlWi {
            vd: VReg::V1,
            vs2: VReg::V2,
            uimm: 3,
            vm: true,
...
fn test_vnsra_wv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VnsraWv {
            vd: VReg::V1,
            vs2: VReg::V2,
            vs1: VReg::V3,
            vm: true,
...
fn test_vnsra_wx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VnsraWx {
            vd: VReg::V1,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn test_vnsra_wi() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VnsraWi {
            vd: VReg::V1,
            vs2: VReg::V2,
            uimm: 5,
            vm: true,
...
fn test_vzext_vf2() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VzextVf2 {
            vd: VReg::V1,
            vs2: VReg::V2,
            vm: true,
            rs1: Reg::Zero,
...
fn test_vzext_vf4() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VzextVf4 {
            vd: VReg::V8,
            vs2: VReg::V4,
            vm: true,
            rs1: Reg::Zero,
...
fn test_vzext_vf8() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VzextVf8 {
            vd: VReg::V1,
            vs2: VReg::V2,
            vm: true,
            rs1: Reg::Zero,
...
fn test_vsext_vf2() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VsextVf2 {
            vd: VReg::V1,
            vs2: VReg::V2,
            vm: true,
            rs1: Reg::Zero,
...
fn test_vsext_vf4() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VsextVf4 {
            vd: VReg::V8,
            vs2: VReg::V4,
            vm: true,
            rs1: Reg::Zero,
...
fn test_vsext_vf8() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xWidenNarrowInstruction::VsextVf8 {
            vd: VReg::V1,
            vs2: VReg::V2,
            vm: true,
            rs1: Reg::Zero,
