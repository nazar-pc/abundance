...
fn test_vmul_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmulVv {
            vd: VReg::V1,
            vs2: VReg::V3,
            vs1: VReg::V2,
            vm: true,
...
fn test_vmul_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmulVx {
            vd: VReg::V1,
            vs2: VReg::V3,
            rs1: Reg::Sp,
            vm: true,
...
fn test_vmulh_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmulhVv {
            vd: VReg::V8,
            vs2: VReg::V10,
            vs1: VReg::V9,
            vm: true,
...
fn test_vmulh_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmulhVx {
            vd: VReg::V8,
            vs2: VReg::V12,
            rs1: Reg::A0,
            vm: false,
...
fn test_vmulhu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmulhuVv {
            vd: VReg::V1,
            vs2: VReg::V3,
            vs1: VReg::V2,
            vm: true,
...
fn test_vmulhu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmulhuVx {
            vd: VReg::V1,
            vs2: VReg::V3,
            rs1: Reg::Sp,
            vm: true,
...
fn test_vmulhsu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmulhsuVv {
            vd: VReg::V1,
            vs2: VReg::V3,
            vs1: VReg::V2,
            vm: true,
...
fn test_vmulhsu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmulhsuVx {
            vd: VReg::V1,
            vs2: VReg::V3,
            rs1: Reg::Sp,
            vm: false,
...
fn test_vdivu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VdivuVv {
            vd: VReg::V1,
            vs2: VReg::V3,
            vs1: VReg::V2,
            vm: true,
...
fn test_vdivu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VdivuVx {
            vd: VReg::V1,
            vs2: VReg::V3,
            rs1: Reg::Sp,
            vm: true,
...
fn test_vdiv_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VdivVv {
            vd: VReg::V1,
            vs2: VReg::V3,
            vs1: VReg::V2,
            vm: true,
...
fn test_vdiv_vx_masked() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VdivVx {
            vd: VReg::V16,
            vs2: VReg::V18,
            rs1: Reg::A7,
            vm: false,
...
fn test_vremu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VremuVv {
            vd: VReg::V1,
            vs2: VReg::V3,
            vs1: VReg::V2,
            vm: true,
...
fn test_vremu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VremuVx {
            vd: VReg::V1,
            vs2: VReg::V3,
            rs1: Reg::Sp,
            vm: true,
...
fn test_vrem_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VremVv {
            vd: VReg::V1,
            vs2: VReg::V3,
            vs1: VReg::V2,
            vm: true,
...
fn test_vrem_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VremVx {
            vd: VReg::V1,
            vs2: VReg::V3,
            rs1: Reg::Sp,
            vm: true,
...
fn test_vwmulu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmuluVv {
            vd: VReg::V2,
            vs2: VReg::V6,
            vs1: VReg::V4,
            vm: true,
...
fn test_vwmulu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmuluVx {
            vd: VReg::V2,
            vs2: VReg::V6,
            rs1: Reg::T0,
            vm: true,
...
fn test_vwmulsu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmulsuVv {
            vd: VReg::V2,
            vs2: VReg::V6,
            vs1: VReg::V4,
            vm: true,
...
fn test_vwmulsu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmulsuVx {
            vd: VReg::V2,
            vs2: VReg::V6,
            rs1: Reg::T0,
            vm: false,
...
fn test_vwmul_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmulVv {
            vd: VReg::V2,
            vs2: VReg::V6,
            vs1: VReg::V4,
            vm: true,
...
fn test_vwmul_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmulVx {
            vd: VReg::V2,
            vs2: VReg::V6,
            rs1: Reg::T0,
            vm: true,
...
fn test_vmacc_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmaccVv {
            vd: VReg::V1,
            vs1: VReg::V2,
            vs2: VReg::V3,
            vm: true,
...
fn test_vmacc_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmaccVx {
            vd: VReg::V1,
            rs1: Reg::A0,
            vs2: VReg::V3,
            vm: true,
...
fn test_vnmsac_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VnmsacVv {
            vd: VReg::V1,
            vs1: VReg::V2,
            vs2: VReg::V3,
            vm: true,
...
fn test_vnmsac_vx_masked() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VnmsacVx {
            vd: VReg::V1,
            rs1: Reg::Sp,
            vs2: VReg::V3,
            vm: false,
...
fn test_vmadd_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmaddVv {
            vd: VReg::V1,
            vs1: VReg::V2,
            vs2: VReg::V3,
            vm: true,
...
fn test_vmadd_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VmaddVx {
            vd: VReg::V1,
            rs1: Reg::Sp,
            vs2: VReg::V3,
            vm: true,
...
fn test_vnmsub_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VnmsubVv {
            vd: VReg::V1,
            vs1: VReg::V2,
            vs2: VReg::V3,
            vm: true,
...
fn test_vnmsub_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VnmsubVx {
            vd: VReg::V1,
            rs1: Reg::Sp,
            vs2: VReg::V3,
            vm: false,
...
fn test_vwmaccu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmaccuVv {
            vd: VReg::V2,
            vs1: VReg::V4,
            vs2: VReg::V8,
            vm: true,
...
fn test_vwmaccu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmaccuVx {
            vd: VReg::V2,
            rs1: Reg::A0,
            vs2: VReg::V8,
            vm: true,
...
fn test_vwmacc_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmaccVv {
            vd: VReg::V2,
            vs1: VReg::V4,
            vs2: VReg::V8,
            vm: true,
...
fn test_vwmacc_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmaccVx {
            vd: VReg::V2,
            rs1: Reg::A0,
            vs2: VReg::V8,
            vm: false,
...
fn test_vwmaccsu_vv() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmaccsuVv {
            vd: VReg::V2,
            vs1: VReg::V4,
            vs2: VReg::V8,
            vm: true,
...
fn test_vwmaccsu_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmaccsuVx {
            vd: VReg::V2,
            rs1: Reg::A0,
            vs2: VReg::V8,
            vm: true,
...
fn test_vwmaccus_vx() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xMulDivInstruction::VwmaccusVx {
            vd: VReg::V2,
            rs1: Reg::A0,
            vs2: VReg::V8,
            vm: true,
