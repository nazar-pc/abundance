...
/// RISC-V Zve64x vector store instruction.
///
...
#[rustfmt::skip]
#[doc(hidden)]
pub enum Zve64xStoreInstruction<Reg> {
...
#[instruction]
impl<Reg> const Instruction for Zve64xStoreInstruction<Reg>
where
    Reg: [const] Register,
{
    type Reg = Reg;
...
impl<Reg> fmt::Display for Zve64xStoreInstruction<Reg>
where
    Reg: fmt::Display,
{
