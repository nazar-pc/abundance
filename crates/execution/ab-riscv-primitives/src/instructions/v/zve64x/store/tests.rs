...
fn test_vse8() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xStoreInstruction::Vse {
            vs3: VReg::V1,
            rs1: Reg::Sp,
            vm: true,
            eew: Eew::E8,
...
fn test_vsm() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xStoreInstruction::Vsm {
            vs3: VReg::V0,
            rs1: Reg::A0,
        })
    );
...
fn test_vsse8() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xStoreInstruction::Vsse {
            vs3: VReg::V2,
            rs1: Reg::A0,
            rs2: Reg::A1,
            vm: true,
...
fn test_vsuxei8() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xStoreInstruction::Vsuxei {
            vs3: VReg::V4,
            rs1: Reg::A0,
            vs2: VReg::V2,
            vm: true,
...
fn test_vsoxei16() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xStoreInstruction::Vsoxei {
            vs3: VReg::V4,
            rs1: Reg::A0,
            vs2: VReg::V8,
            vm: true,
...
fn test_vssseg4e64() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xStoreInstruction::Vssseg {
            vs3: VReg::V8,
            rs1: Reg::A0,
            rs2: Reg::A1,
            vm: true,
...
fn test_vsuxseg2ei32() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xStoreInstruction::Vsuxseg {
            vs3: VReg::V4,
            rs1: Reg::A0,
            vs2: VReg::V8,
            vm: true,
...
fn test_vsoxseg3ei8_masked() {
    ...
    assert_eq!(
        decoded,
        Some(Zve64xStoreInstruction::Vsoxseg {
            vs3: VReg::V4,
            rs1: Reg::A0,
            vs2: VReg::V12,
            vm: false,
