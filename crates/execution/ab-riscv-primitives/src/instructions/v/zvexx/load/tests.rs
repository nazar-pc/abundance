...
fn test_vle8ff() {
    ...
    assert_eq!(
        decoded,
        Some(ZveXxLoadInstruction::Vleff {
            vd: VReg::V4,
            rs1: Reg::A1,
            vm: true,
            eew: Eew::E8,
...
fn test_vlse8() {
    ...
    assert_eq!(
        decoded,
        Some(ZveXxLoadInstruction::Vlse {
            vd: VReg::V2,
            rs1: Reg::A0,
            rs2: Reg::A1,
            vm: true,
...
fn test_vluxei8() {
    ...
    assert_eq!(
        decoded,
        Some(ZveXxLoadInstruction::Vluxei {
            vd: VReg::V4,
            rs1: Reg::A0,
            vs2: VReg::V2,
            vm: true,
...
fn test_vloxei16() {
    ...
    assert_eq!(
        decoded,
        Some(ZveXxLoadInstruction::Vloxei {
            vd: VReg::V4,
            rs1: Reg::A0,
            vs2: VReg::V8,
            vm: true,
...
fn test_vlseg3e16ff() {
    ...
    assert_eq!(
        decoded,
        Some(ZveXxLoadInstruction::Vlsegff {
            vd: VReg::V8,
            rs1: Reg::A0,
...
fn test_vlsseg4e64() {
    ...
    assert_eq!(
        decoded,
        Some(ZveXxLoadInstruction::Vlsseg {
            vd: VReg::V8,
            rs1: Reg::A0,
            rs2: Reg::A1,
...
fn test_vluxseg2ei32() {
    ...
    assert_eq!(
        decoded,
        Some(ZveXxLoadInstruction::Vluxseg {
            vd: VReg::V4,
            rs1: Reg::A0,
            vs2: VReg::V8,
            vm_nf: SegVmNf::new(true, Nf::N2),
...
fn test_vloxseg3ei8() {
    ...
    assert_eq!(
        decoded,
        Some(ZveXxLoadInstruction::Vloxseg {
            vd: VReg::V4,
            rs1: Reg::A0,
            vs2: VReg::V12,
...
fn test_display_vle32() {
    ...
    let decoded = ZveXxLoadInstruction::<Reg<u64>>::try_decode(inst).unwrap();
