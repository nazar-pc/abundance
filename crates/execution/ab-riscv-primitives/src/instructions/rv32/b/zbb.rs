...
#[instruction]
impl<Reg> const Instruction for Rv32ZbbInstruction<Reg>
where
    ...
    fn try_decode(instruction: u32) -> Option<Self> {
        ...
        match opcode {
            ...
            0b0010011 => {
                ...
                match funct3 {
                    0b001 => {
                        // RV32: shamt is 5 bits; funct7 distinguishes the operation
                        if funct7 == 0b0110000 {
                            match rs2_bits {
                    ...
                    0b101 => {
                        ...
                        // rev8 for RV32: funct12 = 0b011010011000
                        // rori: funct6 = 0b011000, shamt in bits [24:20]
                        if funct12 == 0b001010000111 {
                            Some(Self::Orcb { rd, rs1 })
                        } else if funct12 == 0b011010011000 {
            ...
            0b0110011 => {
                ...
                match funct3 {
                    ...
                    0b100 => match funct7 {
                        ...
                        // zext.h for RV32 uses OP (0b0110011), funct7=0b0000100, rs2=0
                        0b0000100 => {
                            if rs2_bits == 0 {
