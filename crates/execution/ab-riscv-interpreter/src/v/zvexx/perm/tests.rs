...
fn vslideup_vi_e32_basic() {
    ...
    exec(
        &mut state,
        ZveXxPermInstruction::VslideupVi {
            vd: VReg::V4,
            vs2: VReg::V2,
            uimm: 1,
            vm: true,
...
fn vslidedown_vx_e8_basic() {
    let mut state = setup(Vl::new(6).unwrap(), Vsew::E8, Vlmul::M1);
    for i in 0..16usize {
        write_elem(&mut state, VReg::V2, i, Vsew::E8, (i + 1) as u64);
    }
    state.regs.write(Reg::A0, 2u64);
    exec(
        &mut state,
        ZveXxPermInstruction::VslidedownVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vslidedown_vi_e32_fills_zeros_past_end() {
    ...
    exec(
        &mut state,
        ZveXxPermInstruction::VslidedownVi {
            vd: VReg::V4,
            vs2: VReg::V2,
            uimm: 4,
            vm: true,
...
fn vslide1up_vx_e32_basic() {
    ...
    exec(
        &mut state,
        ZveXxPermInstruction::Vslide1upVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vrgather_vx_e32_all_same_element() {
    ...
    exec(
        &mut state,
        ZveXxPermInstruction::VrgatherVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vrgather_vi_e8_immediate_index() {
    ...
    exec(
        &mut state,
        ZveXxPermInstruction::VrgatherVi {
            vd: VReg::V4,
            vs2: VReg::V2,
            uimm: 5,
            vm: true,
