...
fn exec(
    state: &mut TestInterpreterState<ZveXxCarryInstruction<Reg<u64>>>,
    instr: ZveXxCarryInstruction<Reg<u64>>,
...
fn read_elem(
    state: &TestInterpreterState<ZveXxCarryInstruction<Reg<u64>>>,
    base_reg: VReg,
    elem_i: usize,
    sew: Vsew,
) -> u64 {
...
fn vmsbc_vvm_borrow_out() {
    ...
    exec(
        &mut state,
        ZveXxCarryInstruction::VmsbcVvm {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            rs1: Reg::Zero,
...
fn vmsbc_vxm_e64_exact_boundary() {
    ...
    exec(
        &mut state,
        ZveXxCarryInstruction::VmsbcVxm {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            rs2: Reg::Zero,
