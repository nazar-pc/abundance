...
fn vsaddu_vx_e16() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VsadduVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vsaddu_vi_e8() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VsadduVi {
            vd: VReg::V4,
            vs2: VReg::V2,
            imm: 5,
            vm: true,
...
fn vsadd_vi_sign_extends_immediate() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VsaddVi {
            vd: VReg::V4,
            vs2: VReg::V2,
            imm: -1,
            vm: true,
...
fn vssubu_vv_e8_no_underflow() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VssubuVv {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
fn vssubu_vx_e64_clamps() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VssubuVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vssub_vv_e8_positive_underflow() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VssubVv {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
fn vssub_vx_e32_no_overflow() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VssubVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A1,
            vm: true,
...
fn vaaddu_vv_e8_rnu_basic() {
    ...
    let mut state = setup_with_vxrm(Vl::new(1).unwrap(), Vsew::E8, Vlmul::M1, Vxrm::Rnu);
    write_elem(&mut state, VReg::V2, 0, Vsew::E8, 3);
    write_elem(&mut state, VReg::V1, 0, Vsew::E8, 4);
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VaadduVv {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
fn vaaddu_vv_e8_even_sum_all_modes_same() {
    ...
    for mode in [Vxrm::Rnu, Vxrm::Rne, Vxrm::Rdn, Vxrm::Rod] {
        let mut state = setup_with_vxrm(Vl::new(1).unwrap(), Vsew::E8, Vlmul::M1, mode);
...
fn vaadd_vv_e8_rnu_signed() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VaaddVv {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
fn vaadd_vx_e64_rne() {
    ...
    let mut state = setup_with_vxrm(Vl::new(1).unwrap(), Vsew::E64, Vlmul::M1, Vxrm::Rne);
    write_elem(&mut state, VReg::V2, 0, Vsew::E64, 3);
    state.regs.write(Reg::A0, 4u64);
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VaaddVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vasubu_vv_e8_rdn() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VasubuVv {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
fn vasub_vv_e8_rnu() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VasubVv {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
#[test]
fn vasub_vx_e16_rdn() {
    let mut state = setup_with_vxrm(Vl::new(1).unwrap(), Vsew::E16, Vlmul::M1, Vxrm::Rdn);
    // i16::MIN
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VasubVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vsmul_vv_e16_rnu_rounding() {
    ...
    let mut state = setup_with_vxrm(Vl::new(1).unwrap(), Vsew::E16, Vlmul::M1, Vxrm::Rnu);
    ...
    let mut state2 = setup_with_vxrm(Vl::new(1).unwrap(), Vsew::E16, Vlmul::M1, Vxrm::Rdn);
...
fn vsmul_vx_e16_negative() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VsmulVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vssrl_vv_e8_rdn_basic() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VssrlVv {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
fn vssrl_vx_e32_rne() {
    ...
    let mut state = setup_with_vxrm(Vl::new(1).unwrap(), Vsew::E32, Vlmul::M1, Vxrm::Rne);
    write_elem(&mut state, VReg::V2, 0, Vsew::E32, 7);
    state.regs.write(Reg::A0, 1u64);
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VssrlVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vssrl_vi_e16_rod() {
    ...
    let mut state = setup_with_vxrm(Vl::new(1).unwrap(), Vsew::E16, Vlmul::M1, Vxrm::Rod);
...
fn vssra_vv_e8_rdn_negative() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VssraVv {
            vd: VReg::V4,
            vs2: VReg::V2,
            vs1: VReg::V1,
            vm: true,
...
#[test]
fn vssra_vx_e32() {
    let mut state = setup_with_vxrm(Vl::new(1).unwrap(), Vsew::E32, Vlmul::M1, Vxrm::Rdn);
    // -256
    write_elem(&mut state, VReg::V2, 0, Vsew::E32, 0xFFFF_FF00u64);
    state.regs.write(Reg::A0, 4u64);
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VssraVx {
            vd: VReg::V4,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vssra_vi_e64_rne_tie_to_even() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VssraVi {
            vd: VReg::V4,
            vs2: VReg::V2,
            imm: 2,
            vm: true,
...
fn vnclipu_wv_e8_no_clip() {
    ...
    let mut state = setup_with_vxrm(Vl::new(2).unwrap(), Vsew::E8, Vlmul::M1, Vxrm::Rdn);
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VnclipuWv {
            vd: VReg::V8,
            vs2: VReg::V4,
            vs1: VReg::V2,
            vm: true,
...
fn vnclipu_wx_e16_rnu() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VnclipuWx {
            vd: VReg::V8,
            vs2: VReg::V4,
            rs1: Reg::A0,
            vm: true,
...
fn vnclipu_lmul8_illegal() {
    ...
    let mut state = setup(Vl::new(1).unwrap(), Vsew::E8, Vlmul::M8);
    let result = exec(
        &mut state,
        ZveXxFixedPointInstruction::VnclipuWi {
            vd: VReg::V8,
...
fn vnclip_wx_e16_rnu() {
    ...
    exec(
        &mut state,
        ZveXxFixedPointInstruction::VnclipWx {
            vd: VReg::V8,
            vs2: VReg::V4,
            rs1: Reg::A0,
            vm: true,
...
fn vsaddu_vd_misaligned_m2_faults() {
    ...
    let mut state = setup(Vl::new(2).unwrap(), Vsew::E8, Vlmul::M2);
...
fn vnclip_wi_mf2_odd_vs2_ok() {
    ...
    let mut state = setup(Vl::new(1).unwrap(), Vsew::E8, Vlmul::Mf2);
...
fn vnclipu_wi_mf4_odd_vs2_ok() {
    ...
    let mut state = setup(Vl::new(1).unwrap(), Vsew::E8, Vlmul::Mf4);
...
fn vnclip_vs2_misaligned_m2_faults() {
    ...
    let mut state = setup(Vl::new(1).unwrap(), Vsew::E8, Vlmul::M2);
    let result = exec(
        &mut state,
        ZveXxFixedPointInstruction::VnclipWi {
            vd: VReg::V8,
...
fn vsaddu_aligned_m4_ok() {
    ...
    let mut state = setup(Vl::new(1).unwrap(), Vsew::E8, Vlmul::M4);
    for i in 0..4usize {
...
fn vsadd_all_sew_sizes_max_overflow() {
    for (vsew, max_val, min_val) in [
        ...
        let mut state2 = setup(Vl::new(1).unwrap(), vsew, Vlmul::M1);
...
fn vssrl_rod_result_even_sets_lsb() {
    ...
    let mut state = setup_with_vxrm(Vl::new(2).unwrap(), Vsew::E8, Vlmul::M1, Vxrm::Rod);
