...
fn vwaddu_vx_e8_m1_zero_extends_scalar() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwadduVx {
            vd: VReg::V8,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vwadd_vv_e8_m1_sign_extends() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwaddVv {
            vd: VReg::V8,
            vs2: VReg::V2,
            vs1: VReg::V4,
            vm: true,
...
fn vwadd_vx_e16_m1_sign_extends_scalar() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwaddVx {
            vd: VReg::V8,
            vs2: VReg::V2,
            rs1: Reg::A1,
            vm: true,
...
fn vwsubu_vv_e8_m1_zero_extends() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwsubuVv {
            vd: VReg::V8,
            vs2: VReg::V2,
            vs1: VReg::V4,
            vm: true,
...
fn vwsubu_vx_e8_m1_scalar_truncated_to_sew() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwsubuVx {
            vd: VReg::V8,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vwsub_vv_e8_m1_sign_extends() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwsubVv {
            vd: VReg::V8,
            vs2: VReg::V2,
            vs1: VReg::V4,
            vm: true,
...
fn vwsub_vx_e32_m1_sign_extends() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwsubVx {
            vd: VReg::V8,
            vs2: VReg::V2,
            rs1: Reg::A0,
            vm: true,
...
fn vwaddu_wv_e8_m1_wide_plus_narrow() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwadduWv {
            vd: VReg::V16,
            vs2: VReg::V8,
            vs1: VReg::V4,
            vm: true,
...
fn vwaddu_wx_e16_m1_wide_plus_scalar() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwadduWx {
            vd: VReg::V16,
            vs2: VReg::V8,
            rs1: Reg::A0,
            vm: true,
...
fn vwadd_wx_e32_m1_sign_extends_scalar() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwaddWx {
            vd: VReg::V16,
            vs2: VReg::V8,
            rs1: Reg::A0,
            vm: true,
...
fn vwsubu_wv_e8_m1_zero_extends_narrow() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwsubuWv {
            vd: VReg::V16,
            vs2: VReg::V8,
            vs1: VReg::V4,
            vm: true,
...
fn vwsubu_wx_e16_m1_scalar() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwsubuWx {
            vd: VReg::V16,
            vs2: VReg::V8,
            rs1: Reg::A0,
            vm: true,
...
fn vwsub_wv_e8_m1_sign_extends_narrow() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwsubWv {
            vd: VReg::V16,
            vs2: VReg::V8,
            vs1: VReg::V4,
            vm: true,
...
fn vwsub_wx_e32_m1_sign_extends_scalar() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VwsubWx {
            vd: VReg::V16,
            vs2: VReg::V8,
            rs1: Reg::A0,
            vm: true,
...
fn vnsrl_wx_e32_m1_logical_no_sign_fill() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VnsrlWx {
            vd: VReg::V2,
            vs2: VReg::V8,
            rs1: Reg::A0,
            vm: true,
...
fn vnsra_wv_e8_m1_arithmetic_sign_fills() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VnsraWv {
            vd: VReg::V2,
            vs2: VReg::V8,
            vs1: VReg::V4,
            vm: true,
...
fn vnsra_wx_e32_m1_sign_fills() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VnsraWx {
            vd: VReg::V2,
            vs2: VReg::V8,
            rs1: Reg::A0,
            vm: true,
...
fn vzext_vf4_e32_m1_zero_extends() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VzextVf4 {
            vd: VReg::V8,
            vs2: VReg::V4,
            vm: true,
            rs1: Reg::Zero,
...
fn vzext_vf8_e64_m1_zero_extends() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VzextVf8 {
            vd: VReg::V8,
            vs2: VReg::V4,
            vm: true,
            rs1: Reg::Zero,
...
fn vsext_vf4_e32_m1_sign_extends() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VsextVf4 {
            vd: VReg::V8,
            vs2: VReg::V4,
            vm: true,
            rs1: Reg::Zero,
...
fn vsext_vf8_e64_m1_sign_extends() {
    ...
    exec(
        &mut state,
        ZveXxWidenNarrowInstruction::VsextVf8 {
            vd: VReg::V8,
            vs2: VReg::V4,
            vm: true,
            rs1: Reg::Zero,
...
fn vwaddu_vv_e8_m2_multi_register_group() {
    ...
    let mut state = setup(Vl::new(8).unwrap(), Vsew::E8, Vlmul::M2);
    for i in 0..8usize {
...
fn vnsrl_e16_m2_multi_register_group() {
    ...
    let mut state = setup(Vl::new(8).unwrap(), Vsew::E16, Vlmul::M2);
    for i in 0..8usize {
...
fn vsext_vf2_e16_m2_vs2_high_part_overlap_legal() {
    ...
    let mut state = setup(Vl::new(16).unwrap(), Vsew::E16, Vlmul::M2);
...
fn vzext_vf4_e32_m8_vs2_high_part_overlap_legal() {
    ...
    let mut state = setup(Vl::new(32).unwrap(), Vsew::E32, Vlmul::M8);
    for i in 0..32usize {
