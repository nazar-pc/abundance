...
fn test_clmul_simple() {
    ...
    let instructions = vec![Rv64ZbcInstruction::Clmul {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
    ...
    for instruction in instructions {
        execute_zbc(&mut regs, instruction);
    }
...
fn test_clmulh_simple() {
    ...
    let instructions = vec![Rv64ZbcInstruction::Clmulh {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_clmulr_simple() {
    ...
    let instructions = vec![Rv64ZbcInstruction::Clmulr {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
