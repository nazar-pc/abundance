...
fn test_divw_ignores_upper_bits() {
    ...
    // Upper 32 bits should be ignored
    state.regs.write(Reg::A0, 0xDEAD_BEEF_0000_0014); // 20 in lower 32 bits
    state.regs.write(Reg::A1, 0xCAFE_BABE_0000_0003); // 3 in lower 32 bits
...
fn test_divuw_large_unsigned() {
    ...
    state.regs.write(Reg::A0, 0xFFFF_FFFF); // u32::MAX
    state.regs.write(Reg::A1, 2);
...
fn test_divuw_ignores_upper_bits() {
    ...
    // Upper 32 bits should be ignored
    state.regs.write(Reg::A0, 0xDEAD_BEEF_0000_0064); // 100 in lower 32 bits
    state.regs.write(Reg::A1, 0xCAFE_BABE_0000_0005); // 5 in lower 32 bits
...
fn test_remw_ignores_upper_bits() {
    ...
    // Upper 32 bits should be ignored
    state.regs.write(Reg::A0, 0xDEAD_BEEF_0000_0017); // 23 in lower 32 bits
    state.regs.write(Reg::A1, 0xCAFE_BABE_0000_0005); // 5 in lower 32 bits
...
fn test_remuw_ignores_upper_bits() {
    ...
    // Upper 32 bits should be ignored
    state.regs.write(Reg::A0, 0xDEAD_BEEF_0000_0064); // 100 in lower 32 bits
    state.regs.write(Reg::A1, 0xCAFE_BABE_0000_0007); // 7 in lower 32 bits
...
fn test_remuw_negative_as_unsigned() {
    ...
    state.regs.write(Reg::A0, 0xFFFF_FFFF); // -1 as i32, u32::MAX as u32
    state.regs.write(Reg::A1, 2);
