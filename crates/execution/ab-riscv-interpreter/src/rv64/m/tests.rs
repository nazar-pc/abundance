...
fn test_mul() {
    ...
    let instructions = vec![Rv64MInstruction::Mul {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
    ...
    for instruction in instructions {
        execute_m(&mut regs, instruction);
    }
...
fn test_mulh() {
    ...
    let instructions = vec![Rv64MInstruction::Mulh {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_mulhu() {
    ...
    let instructions = vec![Rv64MInstruction::Mulhu {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_mulhsu() {
    ...
    let instructions = vec![Rv64MInstruction::Mulhsu {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_div() {
    ...
    let instructions = vec![Rv64MInstruction::Div {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_divu() {
    ...
    let instructions = vec![Rv64MInstruction::Divu {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_rem() {
    ...
    let instructions = vec![Rv64MInstruction::Rem {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_remu() {
    ...
    let instructions = vec![Rv64MInstruction::Remu {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_mulw_basic() {
    ...
    let instructions = vec![Rv64MInstruction::Mulw {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_divw_basic() {
    ...
    let instructions = vec![Rv64MInstruction::Divw {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_divuw_basic() {
    ...
    let instructions = vec![Rv64MInstruction::Divuw {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_remw_basic() {
    ...
    let instructions = vec![Rv64MInstruction::Remw {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
...
fn test_remuw_basic() {
    ...
    let instructions = vec![Rv64MInstruction::Remuw {
        rd: EReg::A2,
        rs1: EReg::A0,
        rs2: EReg::A1,
    }];
