...
#[test]
fn test_add() {
    let mut state = initialize_state([Rv64Instruction::Add {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
...
#[test]
fn test_sub() {
    let mut state = initialize_state([Rv64Instruction::Sub {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
...
#[test]
fn test_and() {
    let mut state = initialize_state([Rv64Instruction::And {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
...
#[test]
fn test_or() {
    let mut state = initialize_state([Rv64Instruction::Or {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
...
#[test]
fn test_xor() {
    let mut state = initialize_state([Rv64Instruction::Xor {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
...
#[test]
fn test_sll() {
    let mut state = initialize_state([Rv64Instruction::Sll {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
...
#[test]
fn test_srl() {
    let mut state = initialize_state([Rv64Instruction::Srl {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
...
#[test]
fn test_sra() {
    let mut state = initialize_state([Rv64Instruction::Sra {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);

    state.regs.write(Reg::A0, (-16i64).cast_unsigned());
    state.regs.write(Reg::A1, 2);

    execute(&mut state).unwrap();

    assert_eq!(state.regs.read(Reg::A2), (-4i64).cast_unsigned());
}
...
#[test]
fn test_slt_less() {
    let mut state = initialize_state([Rv64Instruction::Slt {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);

    state.regs.write(Reg::A0, (-5i64).cast_unsigned());
...
#[test]
fn test_sltu() {
    let mut state = initialize_state([Rv64Instruction::Sltu {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
...
#[test]
fn test_addw() {
    let mut state = initialize_state([Rv64Instruction::Addw {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);

    state.regs.write(Reg::A0, 0x0000_0001_8000_0000);
    state.regs.write(Reg::A1, 0x0000_0000_8000_0000);
...
#[test]
fn test_subw() {
    let mut state = initialize_state([Rv64Instruction::Subw {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);

    state.regs.write(Reg::A0, 0x0000_0001_0000_0000);
    state.regs.write(Reg::A1, 1);
...
#[test]
fn test_sllw() {
    let mut state = initialize_state([Rv64Instruction::Sllw {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
...
#[test]
fn test_srlw() {
    let mut state = initialize_state([Rv64Instruction::Srlw {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);

    state.regs.write(Reg::A0, 0xFFFF_FFFF_8000_0000);
    state.regs.write(Reg::A1, 1);

    execute(&mut state).unwrap();

    assert_eq!(state.regs.read(Reg::A2), 0x0000_0000_4000_0000);
}

#[test]
fn test_sraw() {
    let mut state = initialize_state([Rv64Instruction::Sraw {
        rd: Reg::A2,
        rs1: Reg::A0,
        rs2: Reg::A1,
    }]);
    ...
    assert_eq!(state.regs.read(Reg::A2), 0xFFFF_FFFF_C000_0000);
}
...
#[test]
fn test_addi() {
    let mut state = initialize_state([Rv64Instruction::Addi {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 5,
        rs2: Reg::Zero,
...
#[test]
fn test_slti() {
    let mut state = initialize_state([Rv64Instruction::Slti {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 10,
        rs2: Reg::Zero,
...
#[test]
fn test_sltiu() {
    let mut state = initialize_state([Rv64Instruction::Sltiu {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: -1,
        rs2: Reg::Zero,
...
#[test]
fn test_xori() {
    let mut state = initialize_state([Rv64Instruction::Xori {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 0xAA,
        rs2: Reg::Zero,
...
#[test]
fn test_ori() {
    let mut state = initialize_state([Rv64Instruction::Ori {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 0x0F,
        rs2: Reg::Zero,
...
#[test]
fn test_andi() {
    let mut state = initialize_state([Rv64Instruction::Andi {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 0x0F,
        rs2: Reg::Zero,
...
fn test_srai() {
    ...
    assert_eq!(state.regs.read(Reg::A1), (-4i64).cast_unsigned());
}

#[test]
fn test_addiw() {
    let mut state = initialize_state([Rv64Instruction::Addiw {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 5,
        rs2: Reg::Zero,
    ...
    // -5 sign-extended
    state.regs.write(Reg::A0, 0xFFFF_FFFF_FFFF_FFFB);
...
fn test_srliw() {
    ...
    assert_eq!(state.regs.read(Reg::A1), 0x0000_0000_4000_0000);
}
...
fn test_sraiw() {
    ...
    assert_eq!(state.regs.read(Reg::A1), 0xFFFF_FFFF_C000_0000);
}
...
#[test]
fn test_lb() {
    let mut state = initialize_state([Rv64Instruction::Lb {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 10,
        rs2: Reg::Zero,
    ...
    assert_eq!(state.regs.read(Reg::A1), (-5i64).cast_unsigned());
}

#[test]
fn test_lh() {
    let mut state = initialize_state([Rv64Instruction::Lh {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 0,
        rs2: Reg::Zero,
    ...
    assert_eq!(state.regs.read(Reg::A1), (-300i64).cast_unsigned());
}

#[test]
fn test_lw() {
    let mut state = initialize_state([Rv64Instruction::Lw {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 0,
        rs2: Reg::Zero,
    ...
    let data_addr = TEST_BASE_ADDR + 0x100;
    state.memory.write::<i32>(data_addr, -10_0000).unwrap();
    state.regs.write(Reg::A0, data_addr);

    execute(&mut state).unwrap();

    assert_eq!(state.regs.read(Reg::A1), (-10_0000_i64).cast_unsigned());
}

#[test]
fn test_ld() {
    let mut state = initialize_state([Rv64Instruction::Ld {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 0,
        rs2: Reg::Zero,
    ...
    assert_eq!(state.regs.read(Reg::A1), 0x1234_5678_9ABC_DEF0);
}

#[test]
fn test_lbu() {
    let mut state = initialize_state([Rv64Instruction::Lbu {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 0,
        rs2: Reg::Zero,
...
#[test]
fn test_lhu() {
    let mut state = initialize_state([Rv64Instruction::Lhu {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 0,
        rs2: Reg::Zero,
...
#[test]
fn test_lwu() {
    let mut state = initialize_state([Rv64Instruction::Lwu {
        rd: Reg::A1,
        rs1: Reg::A0,
        imm: 0,
        rs2: Reg::Zero,
    ...
    assert_eq!(state.regs.read(Reg::A1), 0xFFFF_FFFF);
}
...
#[test]
fn test_sb() {
    let mut state = initialize_state([Rv64Instruction::Sb {
        rs1: Reg::A0,
        rs2: Reg::A1,
        imm: 0,
    }]);
...
#[test]
fn test_sh() {
    let mut state = initialize_state([Rv64Instruction::Sh {
        rs1: Reg::A0,
        rs2: Reg::A1,
        imm: 0,
    }]);
...
#[test]
fn test_sw() {
    let mut state = initialize_state([Rv64Instruction::Sw {
        rs1: Reg::A0,
        rs2: Reg::A1,
        imm: 0,
    }]);
...
#[test]
fn test_sd() {
    let mut state = initialize_state([Rv64Instruction::Sd {
        rs1: Reg::A0,
        rs2: Reg::A1,
        imm: 0,
    }]);
...
#[test]
fn test_beq_taken() {
    let mut state = initialize_state([Rv64Instruction::Beq {
        rs1: Reg::A0,
        rs2: Reg::A1,
...
fn test_lui_negative() {
    ...
    // Should be sign-extended: 0xffff_ffff_ffff_f000
    assert_eq!(state.regs.read(Reg::A0), 0xffff_ffff_ffff_f000);
}
...
fn test_auipc_negative() {
    ...
    // Should wrap around: PC + sign_extend(0xffff_f000)
    assert_eq!(
        state.regs.read(Reg::A0),
        initial_pc.wrapping_add(0xffff_ffff_ffff_f000)
    );
}
...
#[test]
fn test_fence() {
    let mut state = initialize_state([Rv64Instruction::Fence {
        pred: 0xF,
        succ: 0xF,
        rs1: Reg::Zero,
        rs2: Reg::Zero,
...
#[test]
fn test_ebreak() {
    let mut state = initialize_state([Rv64Instruction::Ebreak {
        rs1: Reg::Zero,
        rs2: Reg::Zero,
    }]);
...
fn test_ecall_unsupported() {
    let mut state = initialize_state([Rv64Instruction::Ecall {
        rs1: Reg::Zero,
        rs2: Reg::Zero,
    }]);
...
#[test]
fn test_unimp() {
    let mut state = initialize_state([Rv64Instruction::Unimp {
        rs1: Reg::Zero,
        rs2: Reg::Zero,
    }]);
