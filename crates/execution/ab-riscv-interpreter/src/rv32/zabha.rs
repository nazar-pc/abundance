...
#[instruction_execution]
const impl<Reg, Env> ExecutableInstructionCsr<Env> for Rv32ZabhaInstruction<Reg> where
    Reg: Register<Type = u32>
{
}
    ...
    fn execute(
        ...
        match self {
            Self::AmoswapB {
                ...
                let old = amo_helpers::amo_read::<i8, _, _>(memory, u64::from(rs1_value))?;
            ...
            Self::AmoswapH {
                ...
                let old = amo_helpers::amo_read::<i16, _, _>(memory, u64::from(rs1_value))?;
