...
pub struct Match {
    ...
    // TODO: Would it be efficient to not store it here?
    pub left_y: u32,
...
// TODO: This expects sorted metadata, which will not necessarily be the case and might need a layer
//  of indirection
/// Compute Chia's `f2()` function from matches in parent table and corresponding metadata
...
pub fn compute_f2(
    ...
    #[spirv(storage_buffer, descriptor_set = 0, binding = 1)] parent_metadatas: &mut [U128],
...
// TODO: This expects sorted metadata, which will not necessarily be the case and might need a layer
//  of indirection
/// Compute Chia's `f3()` function from matches in parent table and corresponding metadata
...
// TODO: This expects sorted metadata, which will not necessarily be the case and might need a layer
//  of indirection
/// Compute Chia's `f4()` function from matches in parent table and corresponding metadata
...
// TODO: This expects sorted metadata, which will not necessarily be the case and might need a layer
//  of indirection
/// Compute Chia's `f5()` function from matches in parent table and corresponding metadata
...
// TODO: This expects sorted metadata, which will not necessarily be the case and might need a layer
//  of indirection
/// Compute Chia's `f6()` function from matches in parent table and corresponding metadata
...
// TODO: This expects sorted metadata, which will not necessarily be the case and might need a layer
//  of indirection
/// Compute Chia's `f7()` function from matches in parent table and corresponding metadata
