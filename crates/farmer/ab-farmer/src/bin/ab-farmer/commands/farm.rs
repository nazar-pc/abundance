...
use ab_farmer::farm::{PlottedSectors, SectorPlottingDetails, SectorUpdate};
use ab_farmer::farmer_cache::{FarmerCache, FarmerCaches};
use ab_farmer::farmer_piece_getter::piece_validator::SegmentRootPieceValidator;
use ab_farmer::farmer_piece_getter::{DsnCacheRetryPolicy, FarmerPieceGetter};
    ...
    PosTable: Table,
{
    ...
    let mut registry = Registry::with_prefix("ab_farmer");
                ...
                async move {
                        ...
                        Err(SingleDiskFarmError::InsufficientAllocatedSpace {
                            ...
                            return (
                                ...
                                Err(anyhow!(
                                    ...
                                    {} bytes to be exact)",
                                    ByteSize::b(allocated_space).display().iec(),
                                    ByteSize::b(allocated_space).display().si(),
                                    ByteSize::b(min_space).display().iec(),
                                    ByteSize::b(min_space).display().si(),
                                    min_space
                                )),
                            );
                        }
                    ...
                    if !no_info {
                        ...
                        info!(
                            ...
                            ByteSize::b(info.allocated_space()).display().si()
                        );
